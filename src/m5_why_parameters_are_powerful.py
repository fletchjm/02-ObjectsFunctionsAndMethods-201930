...
Authors: David Mutchler, Vibha Alangar, Matt Boutell, Dave Fisher,
         Aaron Wilkin, their colleagues, and Micah Fletcher.
...
def main():
    ...
    #better_draw_circles(rg.Point(40, -40), 10)

    #even_better_draw_circles(rg.Point(10, 50), 5, 2, "red", 2)
    #even_better_draw_circles(rg.Point(4, -40), 10, 5, 'blue', 6)

    even_better_draw_circles(rg.Point(-300, 0), 2, 2, 'cyan', 1)
    even_better_draw_circles(rg.Point(-280, 0), 4, 4, 'light blue', 1)
    even_better_draw_circles(rg.Point(-200, 0), 8, 8, 'blue', 1)
    even_better_draw_circles(rg.Point(120, 0), 16, 16, 'navy blue', 1)
    even_better_draw_circles(rg.Point(500, 1), 32, 32, 'dark blue', 1)
...
def better_draw_circles(point, r):
    """
    ...
    for k in range(1, 11):  # k becomes 1, 2, 3, ... 10
        ...
        turtle.pen_down()
        turtle.draw_circle(r * k)  # Radius 15, 30, 45, 60, ...
...
def even_better_draw_circles(point, r, num_circles, color, thickness):
    ...
    for k in range(1, num_circles + 1):  # k becomes 1, 2, 3, ... 10
