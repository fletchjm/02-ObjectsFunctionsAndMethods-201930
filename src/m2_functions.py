...
#
###############################################################################
def get_turtles(color, thick):
    window = rg.TurtleWindow()
    change_thick = rg.SimpleTurtle()
    pen1 = rg.Pen('green', thick)
    change_thick.pen = pen1

    change_color = rg.SimpleTurtle()
    pen2 = rg.Pen(color, 5)
    change_color.pen = pen2

    change_thick.forward(100)

    change_color.backward(100)
